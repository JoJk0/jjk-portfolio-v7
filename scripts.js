            ...
            $("#splash").ready(function(){
                ...
                if($(window).height() > $(window).width()){
                    loadLESS("mobile");
                } else{ $("#splash").css("background-size", "100%"); }
            ...
            $("#hamburger").click(function(){
                ...
                if($(window).scrollTop() > $(window).height()-($('#hamburger').height()+($(window).height()*0.070))){
        ...
        less.modifyVars({
            ...
            '@pageHeight': $(window).height()
                ...
                $("#top_bar_scaffolding").css("height", $("#top_bar").height()+"px");
        ...
        $(window).scroll(function(){
            ...
            if ($(window).scrollTop() > $(window).height()-($('#hamburger').height()+($(window).height()*0.075))){
